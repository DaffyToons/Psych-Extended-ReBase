...
class FreeplayStateNOVANew extends MusicBeatState
{
	static public var filePath:String = 'menuExtendHide/freeplay/';
	static public var instance:FreeplayStateNOVANew;
	...
	override function create()
	{
		...
		detailSongName.setFormat(Paths.font('montserrat.ttf'), Std.int(detailRect.bg1.height * 0.15), 0xFFFFFFFF, LEFT, FlxTextBorderStyle.OUTLINE, 0xFFFFFFFF);
		...
		detailMusican.setFormat(Paths.font('montserrat.ttf'), Std.int(detailRect.bg1.height * 0.09), 0xFFFFFFFF, LEFT, FlxTextBorderStyle.OUTLINE, 0xFFFFFFFF);
		...
		detailPlayText.setFormat(Paths.font('montserrat.ttf'), Std.int(detailRect.bg1.height * 0.09), 0xFFFFFFFF, LEFT, FlxTextBorderStyle.OUTLINE, 0xFFFFFFFF);
		...
		detailTimeText.setFormat(Paths.font('montserrat.ttf'), Std.int(detailRect.bg1.height * 0.09), 0xFFFFFFFF, LEFT, FlxTextBorderStyle.OUTLINE, 0xFFFFFFFF);
		...
		detailBpmText.setFormat(Paths.font('montserrat.ttf'), Std.int(detailRect.bg1.height * 0.09), 0xFFFFFFFF, LEFT, FlxTextBorderStyle.OUTLINE, 0xFFFFFFFF);
		...
		detailMapper.setFormat(Paths.font('montserrat.ttf'), Std.int(detailRect.bg1.height * 0.09), 0xFFFFFFFF, LEFT, FlxTextBorderStyle.OUTLINE, 0xFFFFFFFF);
		...
		songsMove = new MouseMove(FreeplayStateNOVANew, 'songPosiData', 
								[], //无限滑动
								[	
		...
		selectedBG = new FlxSprite(FlxG.width, 0).loadGraphic(Paths.image(FreeplayStateNOVANew.filePath + 'selectBG'));
